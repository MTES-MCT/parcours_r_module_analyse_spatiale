...
Les données spatiales visent à modéliser la terre. 
...
Le *datum* ou *système géodésique* va correspondre aux paramètres de forme de l'ellipsoïde et de positionnement sur celle-ci.
...
Depuis décembre 2000, le système de projection officiel de la France métropolitaine est le Lambert 93 (code EPSG 2154). 
Il s'agit d'une projection conique conforme, référencée à travers le RGF93.   

![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Lambert_conformal_conic.svg/290px-Lambert_conformal_conic.svg.png) 

Ce système a en commun avec le WGS84 - utilisé notamment par le système GPS de positionnement par satellite - l'ellipsoïde de référence IAG GRS80. 
...
Un système même géodésique peut recevoir plusieurs codes EPSG selon son utilisation : 2D ou 3D par exemple. 
C'est le cas du WGS84, dont le code EPSG est 4326 en 2D mais 4979 en 3D.

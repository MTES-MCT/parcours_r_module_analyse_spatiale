...
On procède en 2 temps en raison de la limitation d'interrogation :  

```{r osrmtable2, eval=FALSE}
mat1 <- osrmTable(src = mes_adresses,    # dans le resultat, une ligne par point src
                  dst = restaurants_nantes[1:400, ],                   # dans le resultat, une colonne par point dst
                  osrm.profile = "foot")

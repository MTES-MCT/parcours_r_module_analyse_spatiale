...
mat1 <- osrmTable(src = mes_adresses,                  # dans le résultat, on aura une ligne par point src
                  dst = restaurants_nantes[1:400, ],   # dans le résultat, on aura une colonne par point dst
                  osrm.profile = "foot")
# distances avec les restaurants suivants
mat2 <- osrmTable(src = mes_adresses,
                 dst = restaurants_nantes[401:nrow(restaurants_nantes), ],
                 osrm.profile = "foot")
# Assemblage
mat <- list(durations = bind_cols(mat1$durations, mat2$durations, .name_repair = "unique_quiet"),
            sources = bind_rows(mat1$sources, mat2$sources),
            destinations = bind_rows(mat1$destinations, mat2$destinations))

...
download.file(url, 'extdata/natural-earth_countries-geography.parquet')

# Lire directement depuis l'URL (sans téléchargement intermédiaire)
countries <-  open_dataset('extdata/natural-earth_countries-geography.parquet') %>% 
...
class(countries_sf)  # "sf" "data.frame"
head(countries_sf)

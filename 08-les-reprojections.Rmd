...
Autrefois, la plupart des fonctions de `sf` présupposaient de s'appliquer sur un CRS projeté, car les fonctions de GEOS sur lesquelles elles se basent le font aussi.
...
- l'usage de fonctions recommandant d'utiliser des CRS projetés (comme `st_buffer()` ci-dessus)
